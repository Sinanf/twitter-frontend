    ...
    <div style={{ borderBottom: '1px solid var(--border-color)', paddingBottom: '20px' }}>
      ...
      <div style={{ height: '200px', backgroundColor: '#333639', position: 'relative' }}>
        ...
        <div style={{
          ...
          <img src={reactLogo} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
        </div>
      </div>

      {/* Düzenle Butonu Alanı */}
      ...
      <div style={{ marginTop: '15px', padding: '0 20px' }}>
        <div style={{ fontSize: '24px', fontWeight: '800' }}>{user.firstName || "Kullanıcı Adı"}</div>
        <div style={{ color: '#71767b', fontSize: '15px' }}>@{user.email?.split('@')[0]}</div>

        <div style={{ marginTop: '15px', fontSize: '15px', lineHeight: '1.5' }}>
          Yazılım geliştirici. Kod yazmayı ve kahve içmeyi sever. ☕️ <br/>
          (Bu alan şimdilik statik, ileride veritabanından gelecek)
        </div>
