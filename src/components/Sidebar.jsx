...
<Link to="/explore" className="nav-item" style={{ textDecoration: 'none', color: 'white', display: 'flex', alignItems: 'center', gap: '15px', padding: '10px' }}>
    <FaHashtag size={26} />
    <span style={{ fontSize: '20px', fontWeight: '500' }}>Keşfet</span>
        ...
        <div className="nav-item" style={{ display: 'flex', alignItems: 'center', gap: '15px', padding: '10px', cursor: 'pointer' }}>
          <Link to="/profile" className="nav-item" style={{ textDecoration: 'none', color: 'white', display: 'flex', alignItems: 'center', gap: '15px', padding: '10px', cursor: 'pointer' }}>
            <FaUser size={26} />
